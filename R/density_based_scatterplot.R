...
#'
#' @examples
density_based_scatterplot <- function(wd,path_for_norm_bw,treatment,control,cell_line,histone_mark,gene,intergenic,title_of_plot,window_size,number_of_clusters,pow=NULL,show_legend=FALSE,min,max,bin_size,show_scales=TRUE,xaxis_label,yaxis_label,height_of_figure,width_of_figure){
# parameters
setwd(wd)
getwd()
