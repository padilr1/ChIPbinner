...
ps[[cell_line]]
ggsave((sprintf('figs/%s.%s.%s.%s%sscatterplot.png',cell_line,control,treatment,mark,window_size)), ps[[cell_line]], height = 4, width = 4, device = "png",dpi=600)
...
mv(from = "ps", to = paste0(sprintf('%s.%s.%s.%s%sscatterplot',cell_line,control,treatment,mark,window_size)))
#assign((sprintf('%s.%s.%s.%s.clus.fig',cell_line,control,treatment,mark)), ps)
save(list=paste0(sprintf('%s.%s.%s.%s%sscatterplot',cell_line,control,treatment,mark,window_size)),file=(sprintf('data/plot_data/%s.%s.%s.%s%sscatterplot_data.rda',cell_line,control,treatment,mark,window_size)))
# save legend as data
