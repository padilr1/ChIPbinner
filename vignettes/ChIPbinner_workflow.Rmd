...
norm_bw(out_dir = "output_directory",
        ...
        chip_samp_binned_file = "Cal27.WT.H3K36me2.10kb.bed.gz",
        chip_samp_library_size = 64093770,
        use_control = TRUE,
        control_binned_file = "Cal27.WT_input.H3K36me2.10kb.bed.gz",
...
norm_bw(out_dir = "output_directory",
          genome_assembly = "hg38",
          chip_samp_binned_file = "Cal27.NSD1_KO.H3K36me2.10kb.bed.gz",
          chip_samp_library_size = 18598272,
          use_control = TRUE,
          control_binned_file = "Cal27.NSD1_KO_input.H3K36me2.10kb.bed.gz",
...
annotate_clust(number_of_clusters = 3,
               ...
               pooled_bed_file = "Cal27.WT.NSD1_KO.H3K36me2.10kb_pooled.bed.gz",
