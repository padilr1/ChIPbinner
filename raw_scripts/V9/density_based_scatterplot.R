...
density_based_scatterplot <- function(path_for_norm_bw,
  ...
  ### testing variables ###
  # path = "~/Documents/ChIPbinner/inst/extdata/norm_bw"
  # window_size <- paste0(".", "10", "kb.")
  # treated_samp_label = "NSD1_KO"
  # baseline_samp_label = "WT"
  # cell_line = "Cal27"
  # histone_mark = "H3K36me2"
  # number_of_clusters=as.integer(3)
  # load("~/Documents/ChIPbinner/inst/extdata/cons.Cal27.WT.NSD1_KO.H3K36me2.10kb.rda")
  ### make loop HERE ###
