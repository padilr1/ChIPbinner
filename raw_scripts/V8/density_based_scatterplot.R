...
density_based_scatterplot <- function(path_for_norm_bw,
  ...
  if (number_of_clusters == 2) {
    ...
    ggplot2::ggsave((sprintf("%s/%s.%s.%s.%s%sclus.pdf", out_dir,cell_line, baseline_samp_label, treated_samp_label, mark, window_size)), ps[[cell_line]], height = height_of_figure, width = width_of_figure, dpi = 600, units = "cm", device = cairo_pdf)
